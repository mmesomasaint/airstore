...
export default function Home() {
  const { searchText, setSearchText, searchResults, searchHandler, filter, categories, resetCategories, setCategory, setCondition, setPaymentGateway, setPrice } = useSearch()
